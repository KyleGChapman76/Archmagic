...
public class HUDFPS : MonoBehaviour
{
	...
	public bool fromBottomRight; //have startRect draw from the bottom right instead of the top left
	...
	{
		if (fromBottomRight)
			startRect = new Rect(Screen.width-startRect.x, Screen.height-startRect.y, startRect.width, startRect.width);
		StartCoroutine( FPS() );
	}
